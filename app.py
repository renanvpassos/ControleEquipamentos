...
if menu == "Cadastrar Equipamento":
    ...
    with st.form("cadastro_equipamento_form"):
        ...
        marca = st.selectbox("Marca (Obrigatório)*", ["", "Dell", "HP", "Positivo", "Microsoft", "MSI", "Acer", "Thin Client", "GIC", "AOC", "TP-LINK"])
    ...
    if busca_ref:
        ...
        if not resultados:
            ...
            with st.form("form_edicao_master"):
                ...
                ed_marca = st.selectbox("Marca*", ["Dell", "HP", "Positivo", "Microsoft", "MSI", "Acer", "Thin Client", "GIC", "AOC", "TP-LINK"], index=["Dell", "HP", "Positivo", "Microsoft", "MSI", "Acer", "Thin Client", "GIC", "AOC", "TP-LINK"].index(equip_selecionado['marca']))
