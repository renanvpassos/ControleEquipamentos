...
if menu == "Cadastrar Equipamento":
    ...
    with st.form("cadastro_equipamento_form"):
        ...
        marca = st.selectbox("Marca (Obrigatório)*", ["", "Estação", "Dell", "HP", "Positivo", "Microsoft", "MSI", "Acer", "Thin Client", "GIC", "AOC", "TP-LINK", "Samsung", "Logitech", "Knup", "Jebre", "LG", "Philips"])
...
# --- 2. EDITAR CADASTRO (Apenas Master) ---
    ...
    if equip_selecionado:
        ...
        with st.form("form_edicao_master"):
            ...
            marcas_padrao = ["Estação", "Dell", "HP", "Positivo", "Microsoft", "MSI", "Acer", "Thin Client", "GIC", "AOC", "TP-LINK", "Samsung", "Logitech", "Knup", "Jebre", "LG", "Philips"]
